...
import com.ssplus.hr.security.jwt.TokenProvider;
import com.ssplus.hr.service.AuthenticationService;
import com.ssplus.hr.web.rest.vm.LoginVM;
...
public class UserJWTController {
  ...
  public Response authorize(@Valid LoginVM loginVM) {
    ...
    try {
      System.out.println("==================>" + loginVM.username + "/" + loginVM.password);
